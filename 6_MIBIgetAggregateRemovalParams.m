...
% 
% This is an interactive script that allows you to choose parameters for aggregate removal for each channel. The script works by gaussian-smoothing the data and then removing connected components below a certain size. These should remove any experimental aggregates as well as small clumps left over after noise removal. The script has two parts:
...
% -	capImage - Capping value for plotting. Set to lower to see dynamic range of low-abundant antigens and higher for high-abundant antigens.
...
% -	Create a column called ‘GausFlag’. This should have 1 if this threshold was found using gaussian filtering (default), or 0 if you decided to remove the gaussian step.
% 
% 
% % parameters
